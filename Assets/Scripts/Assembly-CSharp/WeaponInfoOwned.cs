...
public class WeaponInfoOwned : MonoBehaviour
{
        ...
        Dictionary<string, int> customBaseDays = new Dictionary<string, int>
    {
        ...
        // For every 4 levels (integer division), increase the required value by 3.
        // Example: at currentLevel 3, 6, 9, etc., required increases by 4 each time.
        // This does NOT directly allow 3 upgrades every 4 days, but increases a threshold in steps of 3.
        int required = baseDay + (currentLevel / 3) * 4;
