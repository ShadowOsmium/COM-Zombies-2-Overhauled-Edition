...
public class SkillWhirlwinCoopController : SkillCoopController
{
	...
	public override void Init(SkillData data, ObjectController owner)
	{
		...
		human = owner as HumanCoopController;
		if (owner == null)
		{
			Debug.LogError("SkillWhirlwinCoopController owner error.");
		}
		damage_val = 0f;
		Debug.Log("SkillWhirlwinCoopController damage_val:" + damage_val);
	}
