...
public class BaseballRobotCoopController : GuardianForceCoopController
{
	...
	public override void Init()
	{
		...
		SHOOT_STATE = GuardianState.Create(GuardianStateType.Fire, this, true);
	...
	{
		Debug.Log("BaseballRobotCoopController OnGuardianBirth...");
	}
