...
public class CowboyCoopController : PlayerCoopController
{
	...
	{
		base.Awake();
		SCARECROW_SKILL_STATE = PlayerState.Create(PlayerStateType.Scarecrow, this, true);
	}
	...
	public void OnRemoteScarecrowTriger()
	{
		if (cur_guardian_obj != null)
		{
			ScarecrowCoopController component = cur_guardian_obj.GetComponent<ScarecrowCoopController>();
			component.OnRemoteScarecrowTriger();
		}
	}
}
