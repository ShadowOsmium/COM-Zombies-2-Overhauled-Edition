...
public class HumanController : PlayerController
{
	...
	{
		base.Awake();
		WHIRLWIND_SKILL_STATE = PlayerState.Create(PlayerStateType.Whirlwind, this);
		player_state_set.Add(WHIRLWIND_SKILL_STATE.GetStateType(), WHIRLWIND_SKILL_STATE);
	...
	protected override void ResetRenderSet()
	{
		...
		if (base.transform.Find("Avatar_Joe_H_C_01") != null)
		{
			list.Add(base.transform.Find("Avatar_Joe_H_C_01"));
		}
	...
	public void ShowWhirlwindEff()
	{
		...
		whirlwind_obj.GetComponent<EffectAudioBehaviour>().PlayEffect();
	}
