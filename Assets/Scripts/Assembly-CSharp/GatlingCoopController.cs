...
public class GatlingCoopController : WeaponCoopController
{
	...
	public override void Fire(PlayerController player, float deltaTime)
	{
		...
		component4.Init(fire_ori.position, raycastHit.point);
	}
	...
	{
		if (is_inited && GameSceneController.Instance != null && GameSceneController.Instance.player_controller != null)
		{
			player.StopPlayerAudio("ShotGatlin01ServoLoop");
			player.StopPlayerAudio("ShotGatlin01");
			player.StopPlayerAudio("ShotGatlin02");
