...
public class MikeCoopController : PlayerCoopController
{
	...
	{
		base.Awake();
		BASEBALL_ROBOT_SKILL_STATE = PlayerState.Create(PlayerStateType.BaseballRobot, this, true);
	}
	...
	public void OnBaseballRobotSkillEnd()
	{
		...
		if (cur_guardian_obj != null)
		{
			BaseballRobotCoopController component = cur_guardian_obj.GetComponent<BaseballRobotCoopController>();
