...
public class SightBeadScript_Back : MonoBehaviour
{
	...
	private void Update()
	{
		...
		Sight_Bead_Up.transform.Translate(Sight_Bead_Up_Dir * recover_max_speed * Time.deltaTime, Space.World);
		Sight_Bead_Down.transform.Translate(Sight_Bead_Down_Dir * recover_max_speed * Time.deltaTime, Space.World);
		Sight_Bead_Left.transform.Translate(Sight_Bead_Left_Dir * recover_max_speed * Time.deltaTime, Space.World);
		Sight_Bead_Right.transform.Translate(Sight_Bead_Right_Dir * recover_max_speed * Time.deltaTime, Space.World);
		if (Sight_Bead_Up_Dir.y > 0f)
		{
			if (Sight_Bead_Up.transform.localPosition.y >= Sight_Bead_Up_Ori.y)
			{
		...
		else if (Sight_Bead_Up_Dir.y < 0f && Sight_Bead_Up.transform.localPosition.y <= Sight_Bead_Up_Ori.y)
		{
			Sight_Bead_Up.transform.localPosition = Sight_Bead_Up_Ori;
			Sight_Bead_Down.transform.localPosition = Sight_Bead_Down_Ori;
			Sight_Bead_Left.transform.localPosition = Sight_Bead_Left_Ori;
	...
	public void Stretch(float stretch_val)
	{
		...
		Sight_Bead_Up.transform.Translate(Sight_Bead_Up_Start.normalized * stretch_val, Space.World);
		Sight_Bead_Down.transform.Translate(Sight_Bead_Down_Start.normalized * stretch_val, Space.World);
		Sight_Bead_Left.transform.Translate(Sight_Bead_Left_Start.normalized * stretch_val, Space.World);
		Sight_Bead_Right.transform.Translate(Sight_Bead_Right_Start.normalized * stretch_val, Space.World);
