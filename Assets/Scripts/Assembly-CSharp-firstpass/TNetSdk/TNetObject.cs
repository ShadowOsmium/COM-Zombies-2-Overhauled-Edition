...
namespace TNetSdk
{
	public class TNetObject : TDispatchable
	{
		...
		public string GetHostAddresses(string hostNameOrAddress)
		{
			//Discarded unreachable code: IL_0017, IL_003a
			try
			{
			...
			{
				dispatcher.DispatchEvent(PROTOCOLS.version, (CMD)992, null);
				return string.Empty;
			}
		}
	}
